...
<tr><td valign=top>
	<strong>Sistema</strong>
		<ul>
			...
			<li>Perfiles Personalizados: <?php if (isset($datos['sistema']['usar_perfiles_propios']) && $datos['sistema']['usar_perfiles_propios']) {echo 'Sí';} else {echo 'No';} ?>
		</ul>
